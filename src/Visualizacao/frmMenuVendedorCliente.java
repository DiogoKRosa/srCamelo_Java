 ...
 * @author dsm-2
 */
public class frmMenuVendedorCliente extends javax.swing.JFrame {

    /**
     * Creates new form frmMenuVendedor
     */
    public frmMenuVendedorCliente() {
        initComponents();
    }
    ...
    public void adicionarPaineis() {
        ...
        try {
            ...
            Logger.getLogger(frmMenuVendedorCliente.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        btnLocaliza.setBackground(new java.awt.Color(255, 103, 0));
        btnLocaliza.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        btnLocaliza.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                .addGap(0, 0, Short.MAX_VALUE)
                .addComponent(btnLocaliza, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(98, 98, 98))
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(btnLocaliza, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(32, 32, 32))
        );
    ...
    private void btnLocalizaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLocalizaActionPerformed
        loc.setId_cliente(usu.getId());
        
        loc.setId_vendedor(vend.getId());
        loc.inserirLocaliza();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmMenuVendedorCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmMenuVendedorCliente().setVisible(true);
            }
        });
    }
