 ...
 * @author Diogo
 */
public class frmMapaLocaliza extends javax.swing.JFrame {

    /**
     * Creates new form frmMapa
     */
    public frmMapaLocaliza() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmMapaLocaliza.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmMapaLocaliza().setVisible(true);
            }
        });
    }
